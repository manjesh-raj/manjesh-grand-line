...
// `FirstmateCockpit` `UserDefaults` domain (the unbundled binary has no bundle
...
// domain. The real app writes to `com.firstmate.cockpit.native`, a different
...
enum SelfTestDefaultsGuard {
    ...
    private static func recoverFromInterruptedRun() {
        ...
        print("""
              ...
              FirstmateCockpit domain dirty. Restored: \(restored.joined(separator: ", ")).
              """)
    }
