...
final class LockScreenController: NSViewController {
    ...
    private func buildScene(in root: NSView) {
        ...
        boatImageView.image = NSImage(systemSymbolName: "sailboat", accessibilityDescription: "Grand Line")?
    ...
    func apply(_ state: ContentState) {
        ...
        case .avUnavailable:
            ...
            avMessageLabel.stringValue = "Once it's installed, set a password with \u{201c}\(VaultSource.appPasswordSetupCommand)\u{201d} (or Automic Vault's own app) and relaunch Grand Line."
