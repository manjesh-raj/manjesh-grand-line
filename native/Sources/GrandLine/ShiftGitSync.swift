...
final class ShiftGitSync {
    ...
    /// the captain's real `~/Library/Application Support/GrandLine/
    ...
    init(
        ...
        queueLabel: String = "com.manjesh.grandline.shift-git-sync",
    ...
    /// `~/Library/Application Support/GrandLine/shift-repo/`,
    ...
    /// data (the old bare `~/Library/Application Support/GrandLine/
