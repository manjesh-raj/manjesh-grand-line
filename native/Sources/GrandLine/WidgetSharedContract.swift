...
// Foundation. A widget extension cannot link `GrandLine`: it is a
...
enum GrandLineWidgetContainer {
    ...
    /// `<TeamID>.group.com.manjesh.grandline.native`, and the Team ID does
    ...
    static let appGroupIdentifier = "group.com.manjesh.grandline.native"
...
enum GrandLineWidgetKind {
    static let tasksDue = "com.manjesh.grandline.native.widget.tasks-due"
    static let stickyNote = "com.manjesh.grandline.native.widget.sticky-note"
}
...
enum GrandLineWidgetDigest {
    ...
    enum Unavailable: String, Equatable {
        ...
        var detail: String {
            switch self {
            case .neverPublished: return "Open Grand Line once to publish your tasks."
